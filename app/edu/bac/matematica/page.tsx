      ...
      <div style={{ background: '#1e293b', borderBottom: '1px solid #334155', padding: isMobile ? '8px 12px' : '0 24px', display: 'flex', alignItems: 'center', justifyContent: 'space-between', minHeight: '60px', flexShrink: 0, flexWrap: 'wrap', gap: '8px' }}>
        ...
        <div style={{ display: 'flex', gap: '8px', alignItems: 'center' }}>
          <button
            ...
            style={{ background: voiceEnabled ? 'rgba(59,130,246,0.15)' : 'rgba(255,255,255,0.03)', border: `1px solid ${voiceEnabled ? '#3b82f6' : '#334155'}`, borderRadius: '8px', padding: '5px 10px', fontSize: '16px', cursor: 'pointer', color: voiceEnabled ? '#93c5fd' : '#475569', lineHeight: 1 }}
          >
            {voiceEnabled ? '🔊' : '🔇'}
          </button>
          <button
