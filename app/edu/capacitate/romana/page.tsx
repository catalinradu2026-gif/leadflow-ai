  ...
  async function sendMsg(text?: string) {
    ...
    try {
      const res = await fetch('/api/acreditare-chat', {
        ...
        body: JSON.stringify({ messages: newMessages, pagina: 'Capacitate — Română', systemPrompt: SYSTEM_PROMPT }),
      })
