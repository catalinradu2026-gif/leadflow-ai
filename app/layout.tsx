...
export const metadata: Metadata = {
  ...
  keywords: [
    'AI Craiova',
    'ai craiova',
    'automatizare Craiova',
    'automatizari Craiova',
    'automatizare craiova',
    ...
    'agentie automatizari Craiova',
  ].join(', '),
  authors: [{ name: 'AI Craiova', url: 'https://aicraiova.ro' }],
  creator: 'AI Craiova',
  publisher: 'AI Craiova',
  metadataBase: new URL('https://www.aicraiova.ro'),
  alternates: { canonical: 'https://www.aicraiova.ro' },
  category: 'technology',
  openGraph: {
