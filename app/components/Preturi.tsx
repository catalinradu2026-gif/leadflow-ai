  ...
  return (
    <section id="preturi" className="py-32 bg-zinc-950 border-t border-white/5">
      <div className="max-w-6xl mx-auto px-6">
        ...
        <div className="mt-16 relative border border-white/10 bg-black/60 overflow-hidden">
          ...
          <div className="relative z-10 p-10 md:p-14">
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-12">
              {[
                {
                  icon: '📞',
                  titlu: 'Răspunde la telefon automat',
                  desc: 'Preia apelurile la orice oră, identifică motivul și direcționează pacientul: programare, informații, urgență sau departament specific.',
                },
                {
                  icon: '💬',
                  titlu: 'Bot WhatsApp pentru programări',
                  desc: 'Pacienții scriu pe WhatsApp și primesc confirmare de programare, reamintiri automate și instrucțiuni înainte de consultație.',
                },
                {
                  icon: '🏥',
                  titlu: 'Redirecționare pe departamente',
                  desc: 'Sistemul identifică specialitatea necesară și trimite cererea direct la departamentul corect: cardiologie, pediatrie, ATI etc.',
                },
                {
                  icon: '🚨',
                  titlu: 'Notificări urgențe instant',
                  desc: 'Când un pacient semnalează o urgență, medicul de gardă primește notificare imediată pe WhatsApp cu datele și simptomele.',
                },
              ].map((f) => (
            ...
            <div className="border-t border-white/5 pt-10 grid md:grid-cols-2 gap-10 items-end">
              ...
              <div className="flex flex-col gap-4">
                ...
                <a
                  href="https://wa.me/40787813485?text=Buna%20ziua%2C%20vreau%20sa%20programez%20o%20discutie%20despre%20sistemul%20AI%20pentru%20clinica%20mea"
                  target="_blank"
