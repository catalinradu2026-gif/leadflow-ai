    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden bg-black">
      ...
      <div className="relative z-10 text-center max-w-5xl mx-auto px-6">
        <div className="inline-flex items-center gap-2 px-4 py-2 border border-gold/20 bg-gold/5 mb-4">
          ...
          <span className="text-gold text-xs tracking-[0.2em] uppercase">Agenție Automatizări AI</span>
        </div>
        <p className="text-white/50 text-sm md:text-base mb-8">
          Suntem prima agenție din Craiova specializată în automatizări inteligente cu AI.
        </p>

        <h1 className="font-serif text-5xl md:text-7xl font-bold text-white leading-tight mb-6">
          Afacerea ta lucrează{' '}
          <span className="text-gold">singură</span>
        </h1>

        <p className="text-white/60 text-lg md:text-xl max-w-2xl mx-auto mb-4 leading-relaxed">
          Boți WhatsApp inteligenți • Automatizări • Agenți AI 24/7
        </p>
        <p className="text-white/30 text-base max-w-xl mx-auto mb-12">
          Creăm sisteme AI care economisesc zeci de ore pe săptămână pentru afaceri din Craiova și Dolj.
        </p>
        ...
        <p className="text-white/20 text-xs mt-8">Fără costuri ascunse • Răspuns în 24h • Suport în română</p>
      </div>
