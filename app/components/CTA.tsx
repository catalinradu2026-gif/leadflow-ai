        ...
        <div className="border border-white/10 p-8 bg-zinc-950/50">
          {trimis ? (
            <div className="text-center py-12">
              ...
              <h3 className="font-serif text-2xl text-white mb-2">{tr.successTitle}</h3>
              <p className="text-white/40 text-sm">{tr.successSub}</p>
            </div>
          ) : (
            <form onSubmit={handleSubmit} className="space-y-4">
              <h3 className="font-serif text-xl text-white mb-6">{tr.formTitle}</h3>
              <div>
                <input
                  name="nume"
                  value={form.nume}
                  ...
                  required
                  placeholder={tr.numePlaceholder}
              ...
              <div>
                ...
                >
                  <option value="">{tr.businessPlaceholder}</option>
                  {tr.businessOptions.map((opt) => (
              ...
              <p className="text-white/20 text-xs text-center">{tr.submitNote}</p>
            </form>
          )}
        </div>
      </div>
