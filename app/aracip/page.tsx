...
const ARA_GREETING = 'Bună ziua! Sunt ARA, asistentul digital al Agenției ARACIP. Vă ghidez prin autorizare, acreditare și evaluare externă. Cu ce vă pot ajuta?'
